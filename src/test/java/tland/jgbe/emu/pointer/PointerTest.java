package tland.jgbe.emu.pointer;
...
import tland.emu.pointer.Pointer;
...
public class PointerTest {
    ...
    void checkStackPointerPopPush(IEmulator emu, StackPointer sp, short valueToPush) {
    ...
    void testStackPointer() {
        IEmulator emu = new Emulator(null);
