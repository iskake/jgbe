...
/* 0xff */ new RST_vec("rst $38"),
     ...
     */
    public static String getInstructionName(IGameBoy emu, short address) {
        ...
        byte[] operands = {
                emu.readMemoryAddress(Bitwise.toShort(address + 1)),
                emu.readMemoryAddress(Bitwise.toShort(address + 2))
        };
